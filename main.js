...
document.addEventListener('DOMContentLoaded', function() {
  ...
  expandedView.innerHTML = `
    ...
    <p id="expanded-description" class="text-gray-700 dark:text-gray-200 mb-4 inter"></p>
    <div class="mt-6">
      <button class="apply-btn bg-blue-600 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded mr-4">
        Apply Now
      </button>
      <button class="share-btn bg-gray-200 hover:bg-gray-300 text-gray-800 font-bold py-2 px-4 rounded dark:bg-gray-700 dark:hover:bg-gray-600 dark:text-white">
        Share
      </button>
    </div>
  `;
